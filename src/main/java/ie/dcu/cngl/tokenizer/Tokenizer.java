package main.java.ie.dcu.cngl.tokenizer;
...
public class Tokenizer implements ITokenizer {
    ...
    public String getValue()  {
        ...
        setmLastTokenIndex(getmLastTokenIndex() + 1);
	...
	public int getmLastTokenIndex() {
		return mLastTokenIndex;
	}

	public void setmLastTokenIndex(int mLastTokenIndex) {
		this.mLastTokenIndex = mLastTokenIndex;
	}
